	...
	<td class="con_box" align="center">
		<table>
			...
			<tr>
				...
				<td><input class="input_box" type="password" name="mpw" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="con_text">이름: </td>
				<td><input class="input_box" type="text" name="mname" value="${memberDto.mname }" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="con_text">이메일: </td>
				<td><input class="input_box" type="text" name="memail" value="${memberDto.memail }" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="con_text">가입일: </td>
				<td><input class="input_box" type="text" name="memail" value="${memberDto.mdate }" readonly="readonly"></td>
			</tr>
			<tr><td colspan=2>&nbsp;</td></tr>
			<tr>
				<td colspan=2 align="center">
					<input type="button" class="con_btn" value="수정완료">&nbsp;&nbsp;
