	...
	<td class="con_box" align="center">
		<table>
			...
			<tr>
				...
				<td><input class="input_box" type="text" name="qbtitle" value="${boardDto.qbtitle }" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="con_text">내용</td>
				<td><textarea class="btextarea" rows="10" cols="30" name="qbcontent" readonly="readonly">
			...
			<tr>
				<td colspan=2 align="center">
					<input type="button" class="con_btn" value="수정" onclick="javascript:window.location.href='content_modify?qbnum=${boardDto.qbnum}'">&nbsp;&nbsp;
					<input type="button" class="con_btn" value="삭제" onclick="javascript:window.location.href='content_delete?qbnum=${boardDto.qbnum}'">&nbsp;&nbsp;
					<input type="button" class="con_btn" value="글목록" onclick="javascript:window.location.href='board'">
				</td>
			</tr>		
		</table>
	</td>
